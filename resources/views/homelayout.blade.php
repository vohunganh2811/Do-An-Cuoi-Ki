...
<head>
	<title>SHOP ĐIỆN THOẠI ƯU ĐÃI HÀNG ĐẦU</title>
	<!-- Meta tag Keywords -->
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					@endif
						...
						<!-- <div class="form-group">
							<label class="col-form-label">Thành Viên</label>
							<input type="text" class="form-control" placeholder=" " name="loaithanhvien" required="">
						</div> -->
						<div class="right-w3l">
						...
						<div class="sub-w3l">
							<div class="custom-control custom-checkbox mr-sm-2">
								...
								<label class="custom-control-label" for="customControlAutosizing2">Tôi đồng ý và đăng ký</label>
							</div>
						</div>
						{{ csrf_field() }} 
					</form>
	...
	<script>
		jQuery(document).ready(function ($) {
			...
			$(".readmore").click(function(){
           	 $(".detaiil").slideToggle();
			 $(".detaiil").toggleClass("hidedetail");
        });
		});
